...
export const demoData: AdminData = {
  ...
  items: [
    { id: 'i1', org_id: 'org-1', zone_id: 'z1', name: 'Sunrise Maize Meal 10kg', sku: 'SM-10KG', barcode: '600100100001', unit: 'bag', category: 'Staples', selling_price: 120, system_qty: 248, updated_at: daysAgo(1) },
    { id: 'i2', org_id: 'org-1', zone_id: 'z1', name: 'Golden Grain Rice 5kg', sku: 'GG-RICE-5', barcode: '600100100002', unit: 'bag', category: 'Staples', selling_price: 90, system_qty: 174, updated_at: daysAgo(1) },
    { id: 'i3', org_id: 'org-1', zone_id: 'z1', name: 'Clearwater Cooking Oil 2L', sku: 'CW-OIL-2', barcode: '600100100003', unit: 'bottle', category: 'Pantry', selling_price: 45, system_qty: 96, updated_at: daysAgo(2) },
    { id: 'i4', org_id: 'org-1', zone_id: 'z2', name: 'Fresh Milk 1L', sku: 'FM-1L', barcode: '600100100004', unit: 'carton', category: 'Chilled', selling_price: 23, system_qty: 82, updated_at: daysAgo(1) },
    { id: 'i5', org_id: 'org-1', zone_id: 'z2', name: 'Farmhouse Yoghurt 500ml', sku: 'FY-500', barcode: '600100100005', unit: 'cup', category: 'Chilled', selling_price: 18, system_qty: 61, updated_at: daysAgo(1) },
    { id: 'i6', org_id: 'org-1', zone_id: 'z3', name: 'Crisp & Co. Potato Chips', sku: 'CC-CHIPS', barcode: '600100100006', unit: 'packet', category: 'Snacks', selling_price: 3, system_qty: 132, updated_at: daysAgo(3) },
    { id: 'i7', org_id: 'org-1', zone_id: 'z3', name: 'Bright Cola 500ml', sku: 'BC-500', barcode: '600100100007', unit: 'bottle', category: 'Drinks', selling_price: 5, system_qty: 206, updated_at: daysAgo(2) },
    { id: 'i8', org_id: 'org-1', zone_id: 'z3', name: 'Cedar Soap Bar', sku: 'CS-BAR', barcode: '600100100008', unit: 'bar', category: 'Household', selling_price: 2, system_qty: 118, updated_at: daysAgo(4) },
  ],
  sessions: [
