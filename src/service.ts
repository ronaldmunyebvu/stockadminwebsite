...
export async function signOutAdmin() { try { await request<{ ok: true }>('/api/auth/logout', { method: 'POST' }) } catch { } localStorage.removeItem('ClickCount_admin_token') }
